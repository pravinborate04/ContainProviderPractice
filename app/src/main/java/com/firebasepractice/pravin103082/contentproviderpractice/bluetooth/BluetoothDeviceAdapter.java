...
public class BluetoothDeviceAdapter extends ArrayAdapter<BluetoothADevice> {
    ...
    List<BluetoothADevice> bluetoothADevices;



    public BluetoothDeviceAdapter(Context context, List<BluetoothADevice> bluetoothADevices) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(bluetoothADevices.get(position).getName()!=null){
            ...
            holder.textView.setText(bluetoothADevices.get(position).getPhysicalAddress());
