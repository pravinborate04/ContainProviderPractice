package com.firebasepractice.pravin103082.contentproviderpractice.search.whatsapp_like_search;
...
public class WhatsAppActivity extends AppCompatActivity {
    ...
    public void initSearchView()
    {
        ...
        txtSearch.setTextColor(getResources().getColor(R.color.whatappColorPrimary));
