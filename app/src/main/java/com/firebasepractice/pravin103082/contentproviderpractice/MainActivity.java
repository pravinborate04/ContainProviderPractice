...
public class MainActivity extends AppCompatActivity {
    ...
    private static final int REQUEST_ENABLE_BT =000 ;
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        btnCustomFile.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if(checkStoragePermission()){
                    Intent intent = new Intent(MainActivity.this, CustomTxtFileCreateActivity.class);
                    //              intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK|Intent.FLAG_ACTIVITY_CLEAR_TASK);
                    startActivity(intent);
                }else {
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if(requestCode==REQUEST_ENABLE_BT){
            if(resultCode==RESULT_OK){
                ...
                Toast.makeText(this, "BlueTooth Enbled", Toast.LENGTH_SHORT).show();
